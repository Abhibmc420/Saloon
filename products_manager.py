...
class ProductsManager:
    def __init__(self):
        self.data_manager = DataManager("data/products.json")
    ...
    def show_products_list(self):
        ...
        products = self.data_manager.load_data()
        ...
        with st.form("add_product_form"):
            ...
            if submitted:
                if name and brand and category and cost_price >= 0 and selling_price >= 0:
                    ...
                    if self.data_manager.add_item(product_data):
    ...
    def edit_product_form(self):
        ...
        if selected_product_key:
            ...
            product = self.data_manager.get_item_by_id(product_id)
                ...
                with st.form("edit_product_form"):
                    ...
                    if submitted:
                        if name and brand and category and cost_price >= 0 and selling_price >= 0:
                            ...
                            if self.data_manager.update_item(product_id, updated_product):
