...
class ServicesManager:
    def __init__(self):
        self.data_manager = DataManager("data/services.json")
    ...
    def show_services_list(self):
        ...
        services = self.data_manager.load_data()
        ...
        with st.form("add_service_form"):
            ...
            if submitted:
                if name and category and base_price > 0:
                    ...
                    if self.data_manager.add_item(service_data):
    ...
    def edit_service_form(self):
        ...
        if selected_service_key:
            ...
            service = self.data_manager.get_item_by_id(service_id)
                ...
                with st.form("edit_service_form"):
                    ...
                    if submitted:
                        if name and category and base_price > 0:
                            ...
                            if self.data_manager.update_item(service_id, updated_service):
